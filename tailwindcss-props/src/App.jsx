...
function App() {
  ...
  return (
    <>
     ...
     <h1 className='bg-green-600 rounded-xl p-7'>Tailwind and props</h1>
     <Card name="Paro" btnText="Click Here"/>
     <Card name="Tara" btnText="Don't Click Here"/>
     
    {/* example Tailwindcss using: https://www.devui.io/*/}
